...
warning_output_template = "::warning file={file},line={line},col={col}::{msg}"
...
with open('pmd-output.json') as file:
  ...
  for file in data['files']:
    for v in file['violations']:
      ...
      warning_output = warning_output_template.format(file = file['filename'], line = v['beginline'], col = v['begincolumn'], msg = warning_message)
